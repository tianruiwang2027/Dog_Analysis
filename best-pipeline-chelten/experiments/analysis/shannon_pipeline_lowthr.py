...
s1_scg, s2_scg, cand_scg = pick_doublets(ts_sd, sharp_s, fsd_s, thr=SCG_THR)
...
with open(f"/tmp/shannon_restricted_results_thr{SCG_THR}.pkl","wb") as f:
...
print(f"saved results+diagnostics pickle (SCG_THR={SCG_THR}, ECG_THR={ECG_THR})")
