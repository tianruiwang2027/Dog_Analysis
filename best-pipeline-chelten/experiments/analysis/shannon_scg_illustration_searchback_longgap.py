...
w0 = np.datetime64("2026-06-26T17:45:00").astype("datetime64[us]").astype(int)
w1 = np.datetime64("2026-06-26T17:45:25").astype("datetime64[us]").astype(int)
...
fig.suptitle("[Chelten] SCG Shannon pipeline, search-back with NO upper bound on gap length -- 17:45:00-17:45:25", fontsize=13)
fig.tight_layout()
out = "/tmp/dog-test-ecg/dog-test-ecg-code/figs/chelten_shannon_scg_searchback_longgap_illustration.png"
