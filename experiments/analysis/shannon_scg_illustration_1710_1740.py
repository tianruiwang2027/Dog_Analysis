...
w0 = np.datetime64("2026-06-26T17:47:10").astype("datetime64[us]").astype(int)
w1 = np.datetime64("2026-06-26T17:47:40").astype("datetime64[us]").astype(int)
...
fig.suptitle(f"[Chelten] SCG Shannon-energy S1/S2 pipeline, threshold={THR} -- 17:47:10-17:47:40", fontsize=13)
fig.tight_layout()
out = "/tmp/dog-test-ecg/dog-test-ecg-code/figs/chelten_shannon_scg_illustration_1710_1740.png"
