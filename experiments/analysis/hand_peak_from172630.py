...
annotation span (~17:26:30-18:00:00), restricted to time where BOTH signals
...
axT.set_title("Hand-annotated beats, 3s-smoothed HR, joint-good time -- 17:26:30-18:00:00")
...
fig.suptitle("[Chelten] SCG vs Polar HR, hand-annotated beats, joint-good -- 17:26:30-18:00:00", fontsize=13)
fig.tight_layout()
out = "/tmp/dog-test-ecg/dog-test-ecg-code/figs/chelten_hand_peak_from172630.png"
